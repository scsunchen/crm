    ...
    <div class="form-group">
        ...
        <div class="btn-group pull-right">
            ...
            <ul class="dropdown-menu">
                <li><button class="btn btn-default btn-block" type="submit"  name="register"><spring:message code="BusinessPartner.Table.MerchantRegistration"></spring:message></button></li>
                <li><button class="btn btn-default btn-block" type="submit"  name="update"><spring:message code="BusinessPartner.Table.MerchantUpdate"></spring:message></button></li>
                <li role="separator" class="divider"></li>
                <li><button class="btn btn-default btn-block" type="submit"  name="deactivation"><spring:message code="BusinessPartner.Table.MerchantDeactiovation"></spring:message></button></li>
            </ul>
        </div>
    </div>
</form:form>
