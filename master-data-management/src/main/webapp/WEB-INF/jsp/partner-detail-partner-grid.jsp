  ...
  <fieldset class="col-lg-12">
    <div class="form-group">
      <div class="col-lg-6">
        ...
        <input:inputField label="Ime i prezime *" name="name"/>
      </div>
      <div class="col-lg-3">
      ...
      <div class="col-lg-3">
        ...
        <div class="form-group">
          <label for="POStype">Vrsta objekta</label>
          <form:select path="POStype" id="POStype" class="form-control" itemLabel="POStype">
            <%--
            <form:option value="${POStype}">${POStypeDescription}</form:option>
            --%>
            <form:options items="${POStypes}" itemLabel="description"/>
          </form:select>
        </div>
      </div>
