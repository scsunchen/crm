...
<div class="table-responsive generic-container">
  <table class="table table-striped">
    <thead>
    <tr>
      <th><a class="btn btn-primary" href="/masterdata/partnerstatus/create.html"><span class="glyphicon glyphicon-plus"></span>
        <spring:message code="Common.Button.Create"></spring:message> </a></th>
      <th><spring:message code="BusinessPartnerStatus.Table.Id"></spring:message></th>
      <th><spring:message code="BusinessPartnerStatus.Table.Name"></spring:message></th>
      <th><spring:message code="BusinessPartnerStatus.Table.Description"></spring:message></th>
    </tr>
    </thead>
    <tbody>
