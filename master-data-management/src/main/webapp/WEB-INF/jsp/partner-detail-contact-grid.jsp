...
<form:form modelAttribute="item" method="post" cssClass="generic-container">
    ...
    <div class="form-group">
        <a class="btn btn-default"
           href="${pageContext.request.contextPath}/partner/read-contactsdetals-page.html?partnerId=${param['partnerId']}&partnerName=${param['partnerName']}&pointOfSaleId=${param['pointOfSaleId']}&masterPartnerId=${param['masterPartnerId']}&masterPartnerName=${param['masterPartnerName']}&page=${param['page']}">
