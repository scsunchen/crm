...
<form:form modelAttribute="item" method="post" cssClass="generic-container">
    <fieldset>
        <div class="form-group">
            <div class="col-lg-6">
                ...
                <div class="form-group">
                    <label for="serviceProviderName"><spring:message
                            code="BusinessPartnerDevice.Table.serviceProviderName"/></label>
                    ...
                    <form:hidden id="serviceProviderHidden" path="serviceProviderId"/>
                </div>
                <spring:bind path="connectionTypeId">
                    <div class="form-group">
                        <label for="connectionType"><spring:message
                                code="BusinessPartnerDevice.Table.ConnectionType"></spring:message></label>
                ...
                <spring:bind path="refillTypeId">
                    <div class="form-group">
                        <label for="refillType"><spring:message
                                code="BusinessPartnerDevice.Table.RefillType"></spring:message></label>
            ...
            <div class="col-lg-6">
                ...
                <input:inputField name="registrationId" label="DeviceServiceProviderRegistration.Table.Registration"/>
            </div>
    ...
    <div class="form-group">
        <a class="btn btn-default"
           href="${pageContext.request.contextPath}/deviceservprovider/device-serv-provider.html?businessPartnerId=&deviceCustomCode=&page=0">
...
<script type="text/javascript">
    ...
    $('#serviceProviderName').bind('typeahead:selected', function (obj, datum, name) {
        $('#serviceProviderHidden').val(datum['id']);
    });
