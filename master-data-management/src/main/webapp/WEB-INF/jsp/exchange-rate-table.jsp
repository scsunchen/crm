...
<a class="btn btn-primary" href="/masterdata/exchange-rate/${page}/create"><span class="glyphicon glyphicon-plus"></span>
  Kreiraj</a>
<br/>
<br/>
          ...
          <div class="modal-content">
            <div class="modal-body">
              ...
              <h4 class="modal-title" id="myModalLabel">Da li ste sigurni da želite da
                obrišete kurs za ${item.toCurrentcy.ISOCode}?</h4>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-default" data-dismiss="modal">Odustani</button>
              <a type="button" class="btn btn-danger" href="${page}/${item.applicationDate}/${item.toCurrency}/delete.html">Obriši</a>
            </div>
          </div>
        </div>
      </div>
      <tr>
        <td>
          <div class="btn-group btn-group-sm" role="group">
            <a href="${page}/update/${item.applicationDate}/${item.toCurrency}" class="btn btn-primary"><span
        ...
        <td><c:out value="${item.applicationDate}"/></td>
        <td><c:out value="${item.listNumber}"/></td>
        <td><c:out value="${item.toCurrency.ISOCode}"/></td>
        <td><c:out value="${item.buying}"/></td>
        <td><c:out value="${item.middle}"/></td>
        <td><c:out value="${item.selling}"></c:out></td>
      </tr>
