            ...
            <div class="row">
                <p class="pull-left visible-xs visible-sm">
                    <button type="button"
                            ...
                            data-toggle="offcanvas"><span class="glyphicon glyphicon-menu-right"></span>meni
                    </button>
                </p>
            </div>
            <form>
                ...
                <div role="tabpanel">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab"
                                                                  data-toggle="tab">grid-form kobinacija</a></li>
                        <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">list-form
                            kombinacija</a></li>
                        <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">proba</a>
                        </li>
                        <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">proba</a>
                        </li>
                    </ul>
