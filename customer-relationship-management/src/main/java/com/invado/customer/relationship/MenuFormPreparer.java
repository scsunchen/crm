...
public class MenuFormPreparer implements ViewPreparer {
    ...
    public MenuFormPreparer() {
        ...
        crm.put("Transakcije", "Generisanje Faktura", "/crm/transactions/in-transactions.html?id=&invoicingDate=&page=0");
        crm.put("Transakcije", "Preglde Faktura po periodima fakturisnja", "/crm/transactions/review-invoicing-transactions.html?partnerId=&id=&page=0");
