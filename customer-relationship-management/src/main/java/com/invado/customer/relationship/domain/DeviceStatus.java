...
@Entity
@Table(name = "crm_device_status", schema = "devel")
public class DeviceStatus implements Serializable {
    ...
    public DeviceStatusDTO getDTO() {

        DeviceStatusDTO deviceStatusDTO = new DeviceStatusDTO();

        deviceStatusDTO.setId(this.getId());
        deviceStatusDTO.setName(this.getName());
        deviceStatusDTO.setDescription(this.getDescription());
        deviceStatusDTO.setVersion(this.getVersion());
