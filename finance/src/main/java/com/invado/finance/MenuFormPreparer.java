...
//        finance.put("Opsti sifarnici", "Preduzece", "/core/client/0");
//        finance.put("Opsti sifarnici", "Organizaciona jedinica", "/core/org-unit/0");
//        finance.put("Opsti sifarnici", "Poslovni partner", "/core/partner/0");
//        finance.put("Opsti sifarnici", "Opstina", "/core/township/0");
//        finance.put("Opsti sifarnici", "Banka", "/core/bank/0");
//        finance.put("Opsti sifarnici", "Valuta", "/core/currency/0");
//        finance.put("Opsti sifarnici", "Kurs", "/core/exchange-rate/0");
