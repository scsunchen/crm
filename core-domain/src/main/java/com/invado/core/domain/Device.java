...
@NamedQueries({
        ...
        @NamedQuery(name = Device.READ_BY_STATUS,
                query = "SELECT x FROM Device x WHERE UPPER(x.status) = :status"),
...
public class Device implements Serializable {
    ...
    public static final String READ_BY_STATUS = "Device.ReadByStatus";
